...
Example opening tag:  {exp:magpie url="http:///feeds/rss/full/" limit="8" refresh="720"}
...
{exp:magpie url="http:///feeds/rss/full/" limit="10" refresh="720"}
<ul>
{items}
