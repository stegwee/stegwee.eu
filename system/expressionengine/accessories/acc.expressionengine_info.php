...
class Expressionengine_info_acc {
	...
	function _fetch_resources()
	{
		return '
		<ul>
			<li><a href="'.$this->EE->cp->masked_url('http://').'" title=""></a></li>
			<li><a href="'.$this->EE->cp->masked_url('http:///user_guide').'">'.$this->EE->lang->line('documentation').'</a></li>
			<li><a href="'.$this->EE->cp->masked_url('http:///forums').'">'.$this->EE->lang->line('support_forums').'</a></li>
			<li><a href="'.$this->EE->cp->masked_url('https://secure./download.php').'">'.$this->EE->lang->line('downloads').'</a></li>
			<li><a href="'.$this->EE->cp->masked_url('http:///support').'">'.$this->EE->lang->line('support_resources').'</a></li>
		</ul>
		';
	}
	...
	function _fetch_version()
	{
		...
		$download_url = $this->EE->cp->masked_url('https://secure./download.php');
