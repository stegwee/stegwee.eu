	...
	function set_sections()
	{
		$this->sections = array(
			...
			$this->EE->lang->line('support') => '<ul>
						...
						<li><a href="'.$this->EE->cp->masked_url('http:///forums/').'" title="'.$this->EE->lang->line('support_forums').'">'.$this->EE->lang->line('support_forums').'</a></li>
						<li><a href="'.$this->EE->cp->masked_url('http:///wiki/').'" title="'.$this->EE->lang->line('wiki').'" title="'.$this->EE->lang->line('wiki').'">'.$this->EE->lang->line('wiki').'</a></li>
					</ul>'			
		);
	}
